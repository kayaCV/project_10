                    ...
                    <form>
                        <div className="grid-66">
                            <div className="course--header">
                                ...
                                <div><input id="title" name="title" type="text" className="input-title course--title--input" placeholder="Course title..." value=""></input></div>
                                <p>By Joe Smith</p>
                            </div>
                            ...
                            <div className="course--stats">
                                <ul className="course--stats--list">
                                    <li className="course--stats--list--item">
                                        ...
                                        <div><input id="estimatedTime" name="estimatedTime" type="text" className="course--time--input" placeholder="Hours" value=""></input></div>
                                    </li>
                                    <li className="course--stats--list--item">
